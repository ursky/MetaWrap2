#!/usr/bin/env python
# Select FASTA sequences from a file. metaWRAP's blobology module uses this only to pull
...
# options metaWRAP actually uses.
import argparse
import os
import random
import sys
...
def main():
    ...
    ap.add_argument("-s", "--sort", default="S", help="R = random order; anything else keeps input order")
    ap.add_argument("-n", "--numfasta", type=int, default=0, help="number of sequences (default all)")
